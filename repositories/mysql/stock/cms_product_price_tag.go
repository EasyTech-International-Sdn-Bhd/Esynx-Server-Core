...
// DeleteMany sets the ActiveStatus of each record in the input slice to 0 and performs an update
// operation on the repository using the UpdateMany method. It returns an error if any update operation fails.
